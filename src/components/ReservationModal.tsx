...
const ReservationModal = ({ open, onOpenChange, defaultRetreat = "split", onSwitchToWaitlist }: ReservationModalProps) => {
  ...
  const retreatLabel = form.retreat === "split" ? "Split · 7 – 13 Nov 2026" : "Villa · Aug 2027";
  const balanceDueDate = form.retreat === "split" ? "September 8, 2026" : "July 21, 2026";
                ...
                <div className="grid gap-3">
                  ...
                  >
                    ...
                    <p className="font-body text-muted-foreground text-xs mt-0.5">
                      7 – 13 Nov 2026 · Radisson Blu · Up to 12 people
                    </p>
                    {form.retreat === "split" && (
